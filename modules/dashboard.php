        ...
        <div class="vk-dash-widget" data-widget-id="quick-actions">
            ...
            <div class="vk-dash-widget-body">
                <div class="vk-dash-actions-grid">
                    ...
                    <a class="vk-dash-action vk-dash-action-blue" href="<?= e(BASE_URL) ?>/modules/invoices/create.php"><span class="vk-dash-action-icon"><i class="bi bi-file-earmark-text"></i></span><strong>Quotation</strong></a>
