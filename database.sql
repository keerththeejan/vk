-- VK Network Enterprise Authentication Schema
-- Import after taking a backup. Safe for fresh installs; existing installs can rely on includes/auth.php for idempotent upgrades.
